...
const CONFIG = {
    ...
    projectName: "OBSIDIAN-FLASH-QUIZZ",
    projectSubtitle: "OBSIDIAN-FLASH-QUIZZ WIKI",
    description: "Official Documentation and Wiki for obsidian-flash-quizz",

    // Versioning Settings
    versioning: {
        type: "local",
        manualVersion: "v1.1.0",
        manualDate: "2026-02-10"
    },

    // GitHub Repository
    repo: "infinition/obsidian-flash-quizz",
    branch: "main",
    ...
    // Footer
    footerText: "© 2026 OBSIDIAN-FLASH-QUIZZ WIKI - All rights reserved",
    ...
    social: {
        discord: null,
        reddit: null,
        github: "https://github.com/infinition/obsidian-flash-quizz", // Virgule respectée par le script
    ...
    badges: {
        ...
        redditLabel: "REDDIT",
        githubLabel: "OBSIDIAN-FLASH-QUIZZ"
    }
};